...
**Статус: ранний этап разработки (MVP-1: парсер Hysteria2).**
...
| MVP-2 | Парсер `vless://` (vanilla TCP/TLS/WS/gRPC) | ⏳ |
| MVP-3 | Парсер `vless://` + REALITY | ⏳ |
| MVP-4 | Парсер `vless://` + REALITY + xhttp | ⏳ |
